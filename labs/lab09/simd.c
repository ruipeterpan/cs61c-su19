...
extern long long int sum(unsigned int*);
extern long long int sum_unrolled(unsigned int*);
extern long long int sum_simd(unsigned int*);
extern long long int sum_simd_unrolled(unsigned int*);
